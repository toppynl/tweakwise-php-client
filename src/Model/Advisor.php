...
class Advisor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'title' => 'string',
        'code' => 'string',
        'questions' => '\Toppy\TweakwiseClient\Model\Question[]'
    ];
    ...
    {
        $this->setIfExists('advisorid', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['advisorid'];
    }

    /**
     * Sets advisorid
     *
     * @param int|null $advisorid ID of the advisor
     *
     * @return self
     */
    public function setAdvisorid($advisorid)
    {
        if (is_null($advisorid)) {
            throw new \InvalidArgumentException('non-nullable advisorid cannot be null');
        }
        $this->container['advisorid'] = $advisorid;
     ...
     * Sets title
     *
     * @param string|null $title Title of the advisor
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code Code of the advisor
     *
     * @return self
     */
     ...
     * Gets questions
     *
     * @return \Toppy\TweakwiseClient\Model\Question[]|null
     */
     ...
     * Sets questions
     *
     * @param \Toppy\TweakwiseClient\Model\Question[]|null $questions List of questions
     *
     * @return self
     */
