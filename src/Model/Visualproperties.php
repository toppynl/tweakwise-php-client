...
/**
 * Visualproperties Class Doc Comment
 *
 * @category Class
 * @package  Toppy\TweakwiseClient
 * @author   OpenAPI Generator team
 ...
 */
class Visualproperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'visualproperties';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rowspan', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets colspan
     *
     * @param int|null $colspan The number of columns the item takes up.
     *
     * @return self
     */
     ...
     * Sets rowspan
     *
     * @param int|null $rowspan The number of rows the item takes up.
     *
     * @return self
     */
    ...
    {
        if (is_null($rowspan)) {
            throw new \InvalidArgumentException('non-nullable rowspan cannot be null');
        }
