...
/**
 * NavigationSortfield Class Doc Comment
 *
 * @category Class
 * @package  Toppy\TweakwiseClient
 * @author   OpenAPI Generator team
 ...
 */
class NavigationSortfield implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'navigationSortfield';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('displaytitle', $data ?? [], null);
    ...
    */
     ...
     * Sets title
     *
     * @param string|null $title Internal name of the sort field
     *
     * @return self
     */
     ...
     * Sets displaytitle
     *
     * @param string|null $displaytitle Sort field display name
     *
     * @return self
     */
    public function setDisplaytitle($displaytitle)
    {
        if (is_null($displaytitle)) {
            throw new \InvalidArgumentException('non-nullable displaytitle cannot be null');
        }
     ...
     * Sets order
     *
     * @param string|null $order Sort field order
     *
     * @return self
     */
     ...
     * Sets isselected
     *
     * @param bool|null $isselected true/false to indicate if sort field is selected
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Navigation URL for selecting the sort field
     *
     * @return self
     */
