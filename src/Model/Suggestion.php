...
class Suggestion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'match' => 'string',
        'navigationLink' => '\Toppy\TweakwiseClient\Model\SuggestionsNavigationLink',
    ...
    protected static $setters = [
        'match' => 'setMatch',
        'navigationLink' => 'setNavigationLink',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('navigationLink', $data ?? [], null);
    ...
    */
     ...
     * Sets match
     *
     * @param string|null $match Suggestion match text
     *
     * @return self
     */
     ...
     * Gets navigationLink
     *
     * @return \Toppy\TweakwiseClient\Model\SuggestionsNavigationLink|null
     */
    public function getNavigationLink()
    {
        return $this->container['navigationLink'];
    }

    /**
     * Sets navigationLink
     *
     * @param \Toppy\TweakwiseClient\Model\SuggestionsNavigationLink|null $navigationLink navigationLink
     *
     * @return self
     */
    public function setNavigationLink($navigationLink)
    {
        if (is_null($navigationLink)) {
            throw new \InvalidArgumentException('non-nullable navigationLink cannot be null');
        }
        $this->container['navigationLink'] = $navigationLink;
