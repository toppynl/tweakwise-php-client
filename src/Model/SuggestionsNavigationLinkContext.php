<?php
/**
 * SuggestionsNavigationLinkContext
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * SuggestionsNavigationLinkContext Class Doc Comment
 *
 * @category Class
 * @package  Toppy\TweakwiseClient
 * @author   OpenAPI Generator team
 ...
 */
class SuggestionsNavigationLinkContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'suggestionsNavigationLinkContext';
    ...
    protected static $openAPITypes = [
        'searchterm' => 'string',
        'category' => '\Toppy\TweakwiseClient\Model\SuggestionsNavigationLinkContextCategory',
        'facetFilters' => '\Toppy\TweakwiseClient\Model\SuggestionsNavigationLinkContextFacetFilter[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('facetFilters', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets searchterm
     *
     * @param string|null $searchterm Searchterm used in the path
     *
     * @return self
     */
     ...
     * Gets category
     *
     * @return \Toppy\TweakwiseClient\Model\SuggestionsNavigationLinkContextCategory|null
     */
     ...
     * Sets category
     *
     * @param \Toppy\TweakwiseClient\Model\SuggestionsNavigationLinkContextCategory|null $category category
     *
     * @return self
     */
     ...
     * Gets facetFilters
     *
     * @return \Toppy\TweakwiseClient\Model\SuggestionsNavigationLinkContextFacetFilter[]|null
     */
     ...
     * Sets facetFilters
     *
     * @param \Toppy\TweakwiseClient\Model\SuggestionsNavigationLinkContextFacetFilter[]|null $facetFilters facetFilters
     *
     * @return self
     */
    public function setFacetFilters($facetFilters)
    {
        if (is_null($facetFilters)) {
            throw new \InvalidArgumentException('non-nullable facetFilters cannot be null');
        }
