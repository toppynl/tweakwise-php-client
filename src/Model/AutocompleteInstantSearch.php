...
/**
 * AutocompleteInstantSearch Class Doc Comment
 *
 * @category Class
 * @package  Toppy\TweakwiseClient
 * @author   OpenAPI Generator team
 ...
 */
class AutocompleteInstantSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'autocompleteInstantSearch';
    ...
    */
     ...
     * Sets isactive
     *
     * @param bool|null $isactive Indicates if instant search is active
     *
     * @return self
     */
     ...
     * Sets searchterm
     *
     * @param string|null $searchterm Search term for instant search
     *
     * @return self
     */
