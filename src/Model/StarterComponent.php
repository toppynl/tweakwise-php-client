...
/**
 * StarterComponent Class Doc Comment
 *
 * @category Class
 * @package  Toppy\TweakwiseClient
 * @author   OpenAPI Generator team
 ...
 */
class StarterComponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'starterComponent';
    ...
    {
        $this->setIfExists('producttile', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getProducttile()
    {
        return $this->container['producttile'];
    }

    /**
     * Sets producttile
     *
     * @param string|null $producttile Compiled Javascript
     *
     * @return self
     */
    public function setProducttile($producttile)
    {
        if (is_null($producttile)) {
            throw new \InvalidArgumentException('non-nullable producttile cannot be null');
        }
        $this->container['producttile'] = $producttile;
