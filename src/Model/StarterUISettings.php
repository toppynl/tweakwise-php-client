...
/**
 * StarterUISettings Class Doc Comment
 *
 * @category Class
 * @package  Toppy\TweakwiseClient
 * @author   OpenAPI Generator team
 ...
 */
class StarterUISettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'starterUISettings';
    ...
    protected static $getters = [
        ...
        'colorswatches' => 'getColorswatches'
    ];
    ...
    {
        $this->setIfExists('addtocartbutton', $data ?? [], null);
        $this->setIfExists('colorswatches', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param bool|null $addtocartbutton addtocartbutton
     *
     * @return self
     */
    public function setAddtocartbutton($addtocartbutton)
    {
        if (is_null($addtocartbutton)) {
            throw new \InvalidArgumentException('non-nullable addtocartbutton cannot be null');
        }
    ...
    {
        return $this->container['colorswatches'];
    }

    /**
     * Sets colorswatches
     *
     * @param bool|null $colorswatches colorswatches
     *
     * @return self
     */
    public function setColorswatches($colorswatches)
    {
        if (is_null($colorswatches)) {
            throw new \InvalidArgumentException('non-nullable colorswatches cannot be null');
        }
        $this->container['colorswatches'] = $colorswatches;
