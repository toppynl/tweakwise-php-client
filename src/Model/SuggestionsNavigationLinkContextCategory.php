<?php
/**
 * SuggestionsNavigationLinkContextCategory
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * SuggestionsNavigationLinkContextCategory Class Doc Comment
 *
 * @category Class
 * @package  Toppy\TweakwiseClient
 * @author   OpenAPI Generator team
 ...
 */
class SuggestionsNavigationLinkContextCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'suggestionsNavigationLinkContextCategory';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('parentPath', $data ?? [], null);
    ...
    */
     ...
     * Sets path
     *
     * @param string|null $path The full path to the category
     *
     * @return self
     */
     ...
     * Sets parentPath
     *
     * @param string|null $parentPath The full path to the parent category
     *
     * @return self
     */
    public function setParentPath($parentPath)
    {
        if (is_null($parentPath)) {
            throw new \InvalidArgumentException('non-nullable parentPath cannot be null');
        }
     ...
     * Sets parentName
     *
     * @param string|null $parentName The parent category name
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link Link to the category
     *
     * @return self
     */
