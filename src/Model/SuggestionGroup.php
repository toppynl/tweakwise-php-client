...
/**
 * SuggestionGroup Class Doc Comment
 *
 * @category Class
 * @package  Toppy\TweakwiseClient
 * @author   OpenAPI Generator team
 ...
 */
class SuggestionGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'suggestionGroup';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'type' => 'string',
        'suggestions' => '\Toppy\TweakwiseClient\Model\Suggestion[]'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Group title as configured in the corresponding algorithm
     *
     * @return self
     */
     ...
     * Gets suggestions
     *
     * @return \Toppy\TweakwiseClient\Model\Suggestion[]|null
     */
     ...
     * Sets suggestions
     *
     * @param \Toppy\TweakwiseClient\Model\Suggestion[]|null $suggestions suggestions
     *
     * @return self
     */
