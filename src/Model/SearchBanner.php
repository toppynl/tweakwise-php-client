...
/**
 * SearchBanner Class Doc Comment
 *
 * @category Class
 * @package  Toppy\TweakwiseClient
 * @author   OpenAPI Generator team
 ...
 */
class SearchBanner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchBanner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('clicktarget', $data ?? [], null);
    ...
    */
     ...
     * Sets imageurl
     *
     * @param string|null $imageurl The image of the searchbanner
     *
     * @return self
     */
     ...
     * Sets clickurl
     *
     * @param string|null $clickurl The url to go to if you click on the banner.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getClicktarget()
    {
        return $this->container['clicktarget'];
    }

    /**
     * Sets clicktarget
     *
     * @param string|null $clicktarget Target to go to if banner is clicked (_blank: It opens the link in a new window. _self: It opens the linked document in the same frame.)
     *
     * @return self
     */
    public function setClicktarget($clicktarget)
    {
        if (is_null($clicktarget)) {
            throw new \InvalidArgumentException('non-nullable clicktarget cannot be null');
        }
        $this->container['clicktarget'] = $clicktarget;
     ...
     * Sets type
     *
     * @param string|null $type The type where this banner will show: (Desktop | Mobile)
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param string|null $location Location of the banner: (ContainerTop | ListTop | ProductsTop)
     *
     * @return self
     */
     ...
     * Sets categoryid
     *
     * @param int|null $categoryid The categoryid where this banner is for
     *
     * @return self
     */
