...
class Category implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'categoryid' => 'int',
        'categorypath' => 'string',
        'children' => '\Toppy\TweakwiseClient\Model\Category[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('categorypath', $data ?? [], null);
    ...
    */
     ...
     * Sets categorypath
     *
     * @param string|null $categorypath Category path
     *
     * @return self
     */
    public function setCategorypath($categorypath)
    {
        if (is_null($categorypath)) {
            throw new \InvalidArgumentException('non-nullable categorypath cannot be null');
        }
     ...
     * Gets children
     *
     * @return \Toppy\TweakwiseClient\Model\Category[]|null
     */
     ...
     * Sets children
     *
     * @param \Toppy\TweakwiseClient\Model\Category[]|null $children Recursive list of child categories
     *
     * @return self
     */
