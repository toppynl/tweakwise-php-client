...
/**
 * SuggestionItemOrigin Class Doc Comment
 *
 * @category Class
 * @package  Toppy\TweakwiseClient
 * @author   OpenAPI Generator team
 ...
 */
class SuggestionItemOrigin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'suggestionItemOrigin';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('itemreference', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of origin
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Display name of the origin
     *
     * @return self
     */
     ...
     * Sets itemreference
     *
     * @param string|null $itemreference Item reference for the origin
     *
     * @return self
     */
    public function setItemreference($itemreference)
    {
        if (is_null($itemreference)) {
            throw new \InvalidArgumentException('non-nullable itemreference cannot be null');
        }
