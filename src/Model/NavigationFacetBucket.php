...
/**
 * NavigationFacetBucket Class Doc Comment
 *
 * @category Class
 * @package  Toppy\TweakwiseClient
 * @author   OpenAPI Generator team
 ...
 */
class NavigationFacetBucket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'navigationFacetBucket';
    ...
    protected static $setters = [
        ...
        'relativeamount' => 'setRelativeamount'
    ];
    ...
    protected static $getters = [
        ...
        'relativeamount' => 'getRelativeamount'
    ];
    ...
    {
        $this->setIfExists('rangemin', $data ?? [], null);
        $this->setIfExists('rangemax', $data ?? [], null);
        $this->setIfExists('relativeamount', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets rangemin
     *
     * @param float|null $rangemin Minimum size of bucket
     *
     * @return self
     */
    ...
    {
        if (is_null($rangemin)) {
            array_push($this->openAPINullablesSetToNull, 'rangemin');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rangemin', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets rangemax
     *
     * @param float|null $rangemax Maximum size of bucket
     *
     * @return self
     */
    ...
    {
        if (is_null($rangemax)) {
            array_push($this->openAPINullablesSetToNull, 'rangemax');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rangemax', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        return $this->container['relativeamount'];
    }

    /**
     * Sets relativeamount
     *
     * @param float|null $relativeamount Relative size of bucket
     *
     * @return self
     */
    public function setRelativeamount($relativeamount)
    {
        if (is_null($relativeamount)) {
            array_push($this->openAPINullablesSetToNull, 'relativeamount');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('relativeamount', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['relativeamount'] = $relativeamount;
