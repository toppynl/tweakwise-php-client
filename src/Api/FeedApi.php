...
class FeedApi
{
     ...
     * @return \Toppy\TweakwiseClient\Model\Feed
     */
    public function feed($instancekey, $profileKey, $tWNSource = null, $tnCid = null, $tnParameters = null, $tnParametersExcept = null)
    {
        list($response) = $this->feedWithHttpInfo($instancekey, $profileKey, $tWNSource, $tnCid, $tnParameters, $tnParametersExcept);
        return $response;
    }
     ...
     * @throws \Toppy\TweakwiseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Toppy\TweakwiseClient\Model\Feed, HTTP status code, HTTP response headers (array of strings)
     */
    public function feedWithHttpInfo($instancekey, $profileKey, $tWNSource = null, $tnCid = null, $tnParameters = null, $tnParametersExcept = null)
    {
        $request = $this->feedRequest($instancekey, $profileKey, $tWNSource, $tnCid, $tnParameters, $tnParametersExcept);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\TweakwiseClient\Model\Feed',
                        $request,
                        $response,
                    );
            }
     ...
     * @return Promise
     */
    public function feedAsync($instancekey, $profileKey, $tWNSource = null, $tnCid = null, $tnParameters = null, $tnParametersExcept = null)
    {
        return $this->feedAsyncWithHttpInfo($instancekey, $profileKey, $tWNSource, $tnCid, $tnParameters, $tnParametersExcept)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return Promise
     */
    public function feedAsyncWithHttpInfo($instancekey, $profileKey, $tWNSource = null, $tnCid = null, $tnParameters = null, $tnParametersExcept = null)
    {
        $returnType = '\Toppy\TweakwiseClient\Model\Feed';
        $request = $this->feedRequest($instancekey, $profileKey, $tWNSource, $tnCid, $tnParameters, $tnParametersExcept);
     ...
     */
    public function feedRequest($instancekey, $profileKey, $tWNSource = null, $tnCid = null, $tnParameters = null, $tnParametersExcept = null)
    {
        // verify the required parameter 'instancekey' is set
        if ($instancekey === null || (is_array($instancekey) && count($instancekey) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instancekey when calling feed'
            );
        }
        // verify the required parameter 'profileKey' is set
        if ($profileKey === null || (is_array($profileKey) && count($profileKey) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $profileKey when calling feed'
            );
        }

        $resourcePath = '/feed/{instancekey}/{profileKey}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = null;
        ...
        if ($profileKey !== null) {
            $resourcePath = str_replace(
                '{' . 'profileKey' . '}',
                ObjectSerializer::toPathValue($profileKey),
                $resourcePath
            );
        }
