...
class CategoryTreeApi
{
     ...
     * @param  float $catid The starting category for the resulting tree. (optional)
     ...
     * @return \Toppy\TweakwiseClient\Model\CategoryTreeResponse
     */
    public function categorytree($instancekey, $tWNSource = null, $catid = null, $tnParameters = null, $tnParametersExcept = null)
    {
        list($response) = $this->categorytreeWithHttpInfo($instancekey, $tWNSource, $catid, $tnParameters, $tnParametersExcept);
        return $response;
    }
     ...
     * @throws \Toppy\TweakwiseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Toppy\TweakwiseClient\Model\CategoryTreeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function categorytreeWithHttpInfo($instancekey, $tWNSource = null, $catid = null, $tnParameters = null, $tnParametersExcept = null)
    {
        $request = $this->categorytreeRequest($instancekey, $tWNSource, $catid, $tnParameters, $tnParametersExcept);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\TweakwiseClient\Model\CategoryTreeResponse',
                        $request,
                        $response,
                    );
            }
     ...
     * @return Promise
     */
    public function categorytreeAsync($instancekey, $tWNSource = null, $catid = null, $tnParameters = null, $tnParametersExcept = null)
    {
        return $this->categorytreeAsyncWithHttpInfo($instancekey, $tWNSource, $catid, $tnParameters, $tnParametersExcept)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return Promise
     */
    public function categorytreeAsyncWithHttpInfo($instancekey, $tWNSource = null, $catid = null, $tnParameters = null, $tnParametersExcept = null)
    {
        $returnType = '\Toppy\TweakwiseClient\Model\CategoryTreeResponse';
        $request = $this->categorytreeRequest($instancekey, $tWNSource, $catid, $tnParameters, $tnParametersExcept);
     ...
     */
    public function categorytreeRequest($instancekey, $tWNSource = null, $catid = null, $tnParameters = null, $tnParametersExcept = null)
    {
        // verify the required parameter 'instancekey' is set
        if ($instancekey === null || (is_array($instancekey) && count($instancekey) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instancekey when calling categorytree'
            );
        }

        $resourcePath = '/categorytree/{instancekey}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = null;
