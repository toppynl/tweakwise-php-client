...
class StarterApi
{
     ...
     * @return \Toppy\TweakwiseClient\Model\StarterResponse
     */
    public function starter($instancekey, $tWNSource = null)
    {
        list($response) = $this->starterWithHttpInfo($instancekey, $tWNSource);
        return $response;
    }

    /**
     * Operation starterWithHttpInfo
     *
     * Starter
     *
     * @param  string $instancekey Instance specific key. (required)
     ...
     * @throws \Toppy\TweakwiseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Toppy\TweakwiseClient\Model\StarterResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function starterWithHttpInfo($instancekey, $tWNSource = null)
    {
        $request = $this->starterRequest($instancekey, $tWNSource);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\TweakwiseClient\Model\StarterResponse',
                        $request,
                        $response,
                    );
            }
     ...
     * @return Promise
     */
    public function starterAsync($instancekey, $tWNSource = null)
    {
        return $this->starterAsyncWithHttpInfo($instancekey, $tWNSource)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation starterAsyncWithHttpInfo
     *
     * Starter
     *
     * @param  string $instancekey Instance specific key. (required)
     ...
     * @return Promise
     */
    public function starterAsyncWithHttpInfo($instancekey, $tWNSource = null)
    {
        $returnType = '\Toppy\TweakwiseClient\Model\StarterResponse';
        $request = $this->starterRequest($instancekey, $tWNSource);
    ...
    /**
     * Create request for operation 'starter'
     *
     * @param  string $instancekey Instance specific key. (required)
     * @param  string $tWNSource The source of the request. See [the article on the request source](https://docs.tweakwise.com/reference/request-source) for more information. (optional)
     *
     ...
     */
    public function starterRequest($instancekey, $tWNSource = null)
    {
        // verify the required parameter 'instancekey' is set
        if ($instancekey === null || (is_array($instancekey) && count($instancekey) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instancekey when calling starter'
            );
        }

        $resourcePath = '/starter/init/{instancekey}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = null;
