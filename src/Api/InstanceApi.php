...
class InstanceApi
{
     ...
     * @return \Toppy\TweakwiseClient\Model\Instance
     */
    public function instance($instancekey, $tWNSource = null)
    {
        list($response) = $this->instanceWithHttpInfo($instancekey, $tWNSource);
        return $response;
    }

    /**
     * Operation instanceWithHttpInfo
     *
     * Instance
     *
     * @param  string $instancekey Instance specific key. (required)
     ...
     * @throws \Toppy\TweakwiseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Toppy\TweakwiseClient\Model\Instance, HTTP status code, HTTP response headers (array of strings)
     */
    public function instanceWithHttpInfo($instancekey, $tWNSource = null)
    {
        $request = $this->instanceRequest($instancekey, $tWNSource);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\TweakwiseClient\Model\Instance',
                        $request,
                        $response,
                    );
            }
     ...
     * @return Promise
     */
    public function instanceAsync($instancekey, $tWNSource = null)
    {
        return $this->instanceAsyncWithHttpInfo($instancekey, $tWNSource)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation instanceAsyncWithHttpInfo
     *
     * Instance
     *
     * @param  string $instancekey Instance specific key. (required)
     ...
     * @return Promise
     */
    public function instanceAsyncWithHttpInfo($instancekey, $tWNSource = null)
    {
        $returnType = '\Toppy\TweakwiseClient\Model\Instance';
        $request = $this->instanceRequest($instancekey, $tWNSource);
    ...
    /**
     * Create request for operation 'instance'
     *
     * @param  string $instancekey Instance specific key. (required)
     * @param  string $tWNSource The source of the request. See [the article on the request source](https://docs.tweakwise.com/reference/request-source) for more information. (optional)
     *
     ...
     */
    public function instanceRequest($instancekey, $tWNSource = null)
    {
        // verify the required parameter 'instancekey' is set
        if ($instancekey === null || (is_array($instancekey) && count($instancekey) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instancekey when calling instance'
            );
        }

        $resourcePath = '/instance/{instancekey}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = null;
