...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://gateway.tweakwisenavigator.com';
    ...
    {
        $report  = 'PHP SDK (Toppy\TweakwiseClient) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://gateway.tweakwisenavigator.com",
                "description" => "Tweakwise gateway endpoint.",
            ],
            [
                "url" => "https://gateway.tweakwisenavigator.net",
                "description" => "Tweakwise gateway endpoint.",
            ]
        ];
    }
